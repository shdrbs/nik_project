	...
	<form id="join_form" method="post">
			...
			<div class="mail_wrap">
				...
				<div class="mail_input_box">
					<input class="mail_input" name="memberMail" placeholder="ex) test@naver.com">
		...
		<button class="cancel_button"onClick="location.href='/'">취소</button>
...
$(document).ready(function(){
	...
	$(".join_button").click(function(){
        ...
        var mailnum =$('.mail_check_input').val();	// 이메일 인증번호 입력란
